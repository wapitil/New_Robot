...
def trapeziusarm():
    '斜展臂'
    audio_file = "/home/pi/Desktop/New_Robot/Tip/TrapeziusArm.mp3"
    play_audio(audio_file)


def handsforward():
    '双手前举'
    audio_file = "/home/pi/Desktop/New_Robot/Tip/HandsForward.mp3"
    play_audio(audio_file)


def touchhead():
    '摸头'
    audio_file = "/home/pi/Desktop/New_Robot/Tip/TouchHead.mp3"
    play_audio(audio_file)
...
def detecting():
    '正在检测'
    audio_file = "/home/pi/Desktop/New_Robot/Tip/Detecting.mp3"
    play_audio(audio_file)
