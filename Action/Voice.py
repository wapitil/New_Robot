...
def GoForward_1(num):
    ...
    for i in range(num):
        for var0, var1, var2, var3 in zip(np.arange(150.0, 160.0, 1.0), np.arange(30.0, 40.0, 1.0), np.arange(150.0, 140.0, -1.0), np.arange(30.0, 20.0, -1.0)):
        ...
        for var0, var1, var2, var3 in zip(np.arange(160.0, 140.0, -1.0), np.arange(40.0, 20.0, -1.0), np.arange(140.0, 160.0, 1.0), np.arange(20.0, 40.0, 1.0)):
            pwm2.setServoAngleP2(3, var0)
            pwm2.setServoAngleP2(5, var1)
            pwm2.setServoAngleP2(9, var2)
            pwm2.setServoAngleP2(11, var3)
